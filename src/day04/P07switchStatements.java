...
public class P07switchStatements {
    public static void main(String[] args) {

        /*
        Kullanıcıdan yılı ve ay numarasını alıp o yıldaki ayda kaç gün oldugunu yazdırın.
         */
        Scanner scan = new Scanner(System.in);
        System.out.println("Lütfen bilgi istediğiniz yılı giriniz");
        int year = scan.nextInt();
        System.out.println("gün sayısını ardığınız ayın numarasını giriniz");
        ...
        switch (numMonth) {
            ...
            case 12:
                numdays=31;
                System.out.println("Girdiğiniz gün sayısı:" +numdays);
                break;
            case 4:
            case 6:
            case 9:
