        ...
        if (giris > 1999.09) {
            ...
            if (cinsiyet == 'E' || cinsiyet == 'e') {
                ...
                if (primGun >= 5000 && hizmetSuresi >= 20) {
                    ...
                    System.out.println("Emekli olabilmek için " + (5000 - primGun) + "gün primi ödemelisiniz.");

                } else if (primGun >= 5000 && hizmetSuresi < 20) {
                    System.out.println("Emekli olabilmek için " + (20 - hizmetSuresi) + "yıl çalışmalısınız.");

                } else {
                    System.out.println("Malesef henğz EYT şartlarının ikisini de sağlamıyorsunuz");
                    System.out.println("Hizmet süresi eksiği:" + (20 - hizmetSuresi)+ "yıl");
                    System.out.println("Eksik prim gün sayısı:" + (5000 - primGun)+ "yıl");
